    ...
    <?php require_once('./templates/header.html') ?>
        ...
        <section class="flex">
            <div class="explain flex">
                <div class="introTitle fadeIn txtOne">
                    <p>Bienvenue sur Adventure Of Heroes.</p>
                </div>
                <div class="introExplain fadeIn txtTwo">
                    <p>Nous avons créé une histoire qui se base sur les "livres dont vous êtes le héros". Il s'agit d'un livre moitié roman, moitié jeu dans lequel vous devenez le héros d'une aventure. A chaque page, vous avez à relever de nombreux défis, et les choix que vous faites vous mènent sur des chemins divers où vous avez toutes sortes de batailles à livrer.</p>
                    <p>Pour nous, notre "site dont vous êtes le héros" fonctionne de maniere bi-linéaire avec toujours 2 choix par environnement. Il y a même une Hardway et une Softway, des chemins plus faciles mais moins rentables et d'autres plus dures mais davantage gratifiants.</p>
                    <p>Chacun des environnements comporte un combat, qui se déroule sous forme de pierre, feuille, ciseau : 3 attaques vous sont alors proposées: Parade, Coup rapide et coup puissant.</p>
                    <div class="table">
                        <div class="sup">
                ...
                <div class="introGoodLuck fadeIn txtThree">
                    <p>Bonne chance.</p>
                </div>
                <div class="btnPlay flex fadeInBtn btnFour">
